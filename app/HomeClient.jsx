  ...
  return (
    <section style={{ margin: '100px 0 0', padding: '0 4px' }}>
      ...
      <div style={{ marginTop: 52, background: '#000', borderRadius: 32, padding: '44px 40px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 24 }}>
        {[
          { emoji: '🔐', title: 'Unforgeable Tickets', body: "Every QR is cryptographically signed by our servers. The signature is tied to the specific reference — any QR not generated by OUSTED is instantly rejected at the gate." },
          { emoji: '💸', title: 'You Keep Your Revenue', body: "Organizers keep their full ticket price. Our fee sits transparently on top — buyers see it, no surprises." },
...
function CompareBanner() {
  return (
    <section style={{ margin: "80px 0 0" }}>
      <div style={{ background: "#000", borderRadius: 28, padding: "36px 36px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 20 }}>
        <div>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "rgba(231,60,126,.15)", border: "1px solid rgba(231,60,126,.3)", borderRadius: 100, padding: "4px 14px", marginBottom: 12 }}>
            <span style={{ fontSize: 10, fontWeight: 900, color: "#e73c7e", letterSpacing: "1.5px" }}>SEE HOW WE COMPARE</span>
          </div>
          <h3 style={{ fontSize: 24, fontWeight: 950, color: "#fff", margin: "0 0 8px", letterSpacing: "-1px" }}>OUSTED vs other ticketing platforms</h3>
          <p style={{ margin: 0, fontSize: 14, color: "rgba(255,255,255,.45)", fontWeight: 600, maxWidth: 420 }}>Revenue, fees, ticket security, reseller tools, automations — a full feature-by-feature breakdown.</p>
        </div>
        <a href="/compare" style={{ background: "#fff", color: "#000", padding: "14px 26px", borderRadius: 16, fontWeight: 900, textDecoration: "none", fontSize: 13, flexShrink: 0, display: "flex", alignItems: "center", gap: 8 }}>
          See Full Comparison →
        </a>
      </div>
    </section>
