...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms and Conditions" lastUpdated={new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}>
      ...
      <p className="legal-p">By accessing or using the OUSTED platform at ousted.live (the "Platform"), creating an account, purchasing a ticket, casting a vote, or acting as a reseller, you agree to be bound by these Terms and Conditions. If you do not agree, you must not use the Platform.</p>
      ...
      <p className="legal-p"><span className="legal-strong">Payment:</span> All payments are processed by Paystack. OUSTED currently receives all payments into its platform account and distributes funds to organisers and resellers according to its internal payout schedule.</p>
      ...
      <p className="legal-p"><span className="legal-strong">Refunds:</span> All ticket sales are final unless an event is cancelled. In case of cancellation, refunds will be processed within 10 business days. OUSTED does not guarantee refunds for postponed events or where you are unable to attend.</p>
      ...
      <p className="legal-p">For questions about these Terms, contact us at <a href="mailto:legal@ousted.live" style={{ color: '#000', fontWeight: 800 }}>legal@ousted.live</a></p>
